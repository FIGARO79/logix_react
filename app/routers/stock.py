...
async def get_stock_item(
    item_code: str, username: str = Depends(permission_required("stock"))
):
    ...
    if item_details is None:
        raise HTTPException(
            status_code=404, detail=f"Artículo {item_code} no encontrado."
        )
