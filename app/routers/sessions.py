...
async def close_location(
    ...
    return await db_counts.close_location_in_session(
        db, data.session_id, data.location_code, username
    )
...
async def reopen_location(
    ...
    return await db_counts.reopen_location_in_session(
        db, data.session_id, data.location_code, username
    )
...
async def get_counts_for_location(
    ...
    return await db_counts.get_counts_for_location(
        db, session_id, location_code, username
    )
