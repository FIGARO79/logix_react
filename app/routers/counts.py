...
async def get_item_for_counting(item_code: str, username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def get_all_counts(username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
@router.post('/counts')
async def add_count(data: Count, username: str = Depends(permission_required("counts"))):
...
async def save_count(data: StockCount, username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def get_count_differences(username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def update_stock_count(count_id: int, data: dict, username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def delete_stock_count(count_id: int, username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def export_counts(username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def get_count_stats(username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def debug_last_counts(limit: int = 20, username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
...
async def export_cycle_count_recordings(username: str = Depends(permission_required("counts")), db: AsyncSession = Depends(get_db)):
    """
