    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            try:
                ...
                print(
                    f"[ROBOT] Warning en goto: {e}. Intentando continuar...", flush=True
                )
            ...
            try:
                ...
                print(
                    f"[ROBOT] Descarga completada en {PO_EXTRACTOR_EXCEL_PATH}",
                    flush=True,
                )
                await browser.close()
                ...
                if os.path.exists(PO_EXTRACTOR_EXCEL_PATH) and (
                    asyncio.get_event_loop().time()
                    - os.path.getmtime(PO_EXTRACTOR_EXCEL_PATH)
                    < 300
                ):
