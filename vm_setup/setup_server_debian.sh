#!/bin/bash
# Logix WMS - Azure/VPS Autoinstaller (Debian 11/12)
...
# 2. Instalar dependencias base (Python, MariaDB/MySQL, Nginx, Compiladores)
...
echo "🗄️ Configurando Base de Datos (MariaDB/MySQL)..."
