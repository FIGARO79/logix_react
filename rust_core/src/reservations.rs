...
pub fn generate_reservation_cache_rust<'py>(
    ...
    for (i, header) in headers.iter().enumerate() {
        ...
        if customer_name_idx.is_none() && (h_lower == "customer_name" || h_lower == "customer name" || (h_lower.contains("customer") && h_lower.contains("name"))) {
            customer_name_idx = Some(i);
        }

        if customer_code_idx.is_none() && (h_lower == "customer_code" || h_lower == "customer code" || h_lower == "customer_number") {
        ...
        if po_number_idx.is_none() && (h_lower == "po_number" || h_lower == "po number" || h_lower == "po_num" || h_lower == "po" || h_lower == "order_number" || h_lower == "order number" || h_lower == "customer_reference" || h_lower == "customer reference") {
