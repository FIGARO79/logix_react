                ...
                {scannerOpen && (
                    <div className="fixed inset-0 bg-black/80 z-[100] flex items-center justify-center p-4">
                        <div className="bg-white rounded-lg p-6 w-full max-w-lg">
                            <h3 className="text-center font-bold text-lg mb-4 text-gray-800">Escanear Código</h3>
                            <div id="audit-reader" className="rounded-lg overflow-hidden mb-4 border-2 border-gray-100"></div>
