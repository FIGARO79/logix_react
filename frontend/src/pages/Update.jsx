        ...
        <div className="max-w-[1400px] mx-auto px-6 py-6 font-sans bg-[#fcfcfc] min-h-screen text-zinc-800">
            ...
            <div className="mb-8 border-b border-zinc-200 pb-6 flex justify-between items-end">
                <div className="flex flex-col gap-0">
                    <h1 className="text-base font-medium text-gray-900 text-zinc-900 tracking-tight">Actualización de Sistema</h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="lg:col-span-2 lg:row-start-1 lg:col-start-1 bg-white border border-zinc-200 shadow-sm p-6">
                    <div className="flex justify-between items-start mb-6">
                        <div>
                            <h3 className="text-[12px] font-medium text-gray-900 text-zinc-900 uppercase tracking-tight">Robot de Sincronización</h3>
                            <p className="text-[8px] text-zinc-500 uppercase font-medium mt-1">Descarga automática de PO / Waybill desde Portal</p>
                        </div>
                        <span className={`text-[9px] font-medium text-gray-900 px-2 py-0.5 rounded ${isRobotRunning ? 'bg-blue-50 text-blue-600' : 'bg-zinc-100 text-zinc-500'}`}>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-end bg-zinc-50 p-4 rounded border border-zinc-100">
                        <div className="flex-1 space-y-1">
                            <label className="text-[9px] font-medium text-gray-900 text-zinc-600 uppercase">Rango de Fecha (ATD)</label>
                        ...
                        <button 
                            ...
                            className="h-9 px-6 bg-[#285f94] text-white text-[10px] font-medium text-gray-900 uppercase tracking-widest rounded hover:bg-[#1e4a74] disabled:bg-zinc-200 transition-all shadow-sm"
                        >
                ...
                <div className="lg:col-span-2 lg:row-start-2 lg:col-start-1 bg-white border border-zinc-200 shadow-sm p-6">
                    <h3 className="text-[12px] font-medium text-gray-900 text-zinc-900 uppercase tracking-tight mb-6">Carga Manual de Ficheros</h3>
                    ...
                    <form onSubmit={handleFileUpdate}>
                        ...
                        >
                            ...
                            <div className="text-zinc-500">
                                <p className="text-[11px] font-medium text-gray-900 uppercase tracking-widest mb-1 text-zinc-700">Click para seleccionar o arrastre archivos</p>
                            ...
                            <div className="mb-6 space-y-2">
                                {files.map((file, idx) => (
                                    <div key={idx} className="flex items-center justify-between p-3 bg-zinc-50 border border-zinc-100 rounded">
                                        <span className="text-[11px] font-medium text-gray-900 text-zinc-800 uppercase tracking-tight">{file.name}</span>
                                        <button type="button" onClick={() => removeFile(idx)} className="text-red-500 hover:text-red-700 text-[9px] font-medium text-gray-900 uppercase">Remover</button>
                                    </div>
                                ))}
                            </div>
                        )}
                            ...
                            <div className="mb-6 bg-zinc-50 border border-zinc-200 p-4 rounded shadow-sm">
                                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4 pb-3 border-b border-zinc-100">
                                    <div className="flex items-center gap-4">
                                        <h4 className="text-[10px] font-medium text-gray-900 text-zinc-500 uppercase tracking-[0.2em]">Filtro de GRN (Archivo 280)</h4>
                                        <div className="flex gap-3 border-l border-zinc-200 pl-4">
                                            <button 
                                                type="button" 
                                                onClick={() => setSelectedGrns([...availableGrns])} 
                                                className={`text-[10px] font-medium text-gray-900 uppercase tracking-tight transition-colors ${selectedGrns.length === availableGrns.length ? 'text-[#285f94]' : 'text-zinc-500 hover:text-zinc-700'}`}
                                            >
                                                Marcar Todas
                                            </button>
                                            <button 
                                                ...
                                                className={`text-[10px] font-medium text-gray-900 uppercase tracking-tight transition-colors ${selectedGrns.length === 0 ? 'text-[#285f94]' : 'text-zinc-500 hover:text-zinc-700'}`}
                                            >
                                                Desmarcar Todas
                                            </button>
                                        </div>
                                    ...
                                    <div className="flex gap-4">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            ...
                                            <span className="text-[10px] font-medium text-gray-900 text-zinc-700 uppercase">Combinar</span>
                                        </label>
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            ...
                                            <span className="text-[10px] font-medium text-gray-900 text-zinc-700 uppercase">Reemplazar</span>
                                        </label>
                                    </div>
                                </div>
                        ...
                        <button disabled={isLoading || files.length === 0} type="submit" className="w-full h-11 bg-zinc-900 text-white text-[11px] font-medium text-gray-900 uppercase tracking-[0.2em] rounded hover:bg-zinc-800 disabled:bg-zinc-100 transition-all shadow-md">
                ...
                <div className="lg:col-span-1 lg:row-span-2 lg:col-start-3 lg:row-start-1 lg:h-full bg-white border border-zinc-200 shadow-sm p-6 flex flex-col justify-between">
                    <div>
                        <h3 className="text-[10px] font-medium text-gray-900 text-zinc-900 uppercase tracking-[0.2em] mb-6 border-b border-zinc-100 pb-2">Mantenimiento de Datos</h3>
                        ...
                        <div className="space-y-8">
                            ...
                            <form onSubmit={async (e) => {
                                ...
                                <label className="text-[10px] font-medium text-gray-900 text-zinc-700 uppercase">Exportación de Históricos</label>
                                ...
                                <button type="submit" className="w-full h-9 border border-zinc-300 text-zinc-700 text-[10px] font-medium text-gray-900 uppercase tracking-widest rounded hover:bg-zinc-50 hover:text-zinc-900 transition-colors">Generar Respaldo</button>
                            </form>

                            {/* Delete GRN from Master */}
                            <div className="space-y-3 pt-6 border-t border-zinc-100">
                                <div className="flex justify-between items-center">
                                    <label className="text-[10px] font-medium text-gray-900 text-zinc-700 uppercase">Limpieza de Maestro (GRN)</label>
                                    <button 
                                        type="button" 
                                        ...
                                        className="text-[10px] font-medium text-gray-900 text-[#285f94] uppercase hover:text-[#1e4a74] hover:underline"
                                    >
                                    ...
                                    <div className="space-y-3">
                                        <div className="flex justify-between items-center">
                                            ...
                                            <div className="flex gap-2">
                                                <button type="button" onClick={() => setSelectedMaestroGrns([...maestroGrns])} className="text-[10px] font-medium text-gray-900 text-zinc-600 hover:text-zinc-800 uppercase">Todas</button>
                                                <button type="button" onClick={() => setSelectedMaestroGrns([])} className="text-[10px] font-medium text-gray-900 text-zinc-600 hover:text-zinc-800 uppercase">Ninguna</button>
                                            </div>
                                        </div>
                                        ...
                                        <form onSubmit={handleDeleteMaestroGrns} className="space-y-2">
                                            ...
                                            <button 
                                                ...
                                                className="w-full h-8 bg-zinc-800 text-white text-[9px] font-medium text-gray-900 uppercase tracking-widest rounded hover:bg-zinc-700 disabled:bg-zinc-100 transition-colors"
                                            >
                    ...
                    <form onSubmit={async (e) => {
                        ...
                        <label className="text-[10px] font-medium text-gray-900 text-red-600 uppercase">Zona de Riesgo: Reset Total</label>
                        ...
                        <button type="submit" className="w-full h-9 bg-red-600 text-white text-[10px] font-medium text-gray-900 uppercase tracking-widest rounded hover:bg-red-700 shadow-sm transition-colors">Limpiar Base de Datos</button>
                    </form>
                </div>
                ...
                <div className="lg:col-span-1 lg:col-start-3 lg:row-start-3 bg-white border border-zinc-200 shadow-sm p-6 text-zinc-800">
                    <h3 className="text-[10px] font-medium text-gray-900 text-zinc-900 uppercase tracking-[0.2em] mb-4 pb-2 border-b border-zinc-100 flex items-center gap-1.5">
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <div key={item.key} className="flex flex-col gap-1 pb-3 border-b border-zinc-100 last:border-0 last:pb-0">
                                <div className="flex justify-between items-center">
                                    <span className="text-[11px] font-medium text-gray-900 text-zinc-900 uppercase tracking-tight">{item.label}</span>
                                ...
                                <div className="flex justify-between items-center text-[10px]">
                                    ...
                                    <span className="font-mono font-medium text-gray-900 text-zinc-800">
