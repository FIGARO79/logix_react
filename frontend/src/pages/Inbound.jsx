                ...
                <form id="main-form" onSubmit={handleFormSubmit}>
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8 mb-2">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            <button type="button" id="printLabelBtn" className="btn-primary h-10 btn-print-label mt-4 flex items-center justify-center gap-2" onClick={() => window.print()}>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5">
                                ...
                                <tr key={log.id}>
                                    ...
                                    <td>
                                        <div className="flex space-x-2">
                                            <button className="text-blue-600 hover:text-blue-800" title="Editar" onClick={() => {
