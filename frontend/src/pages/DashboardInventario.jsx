...
const DashboardInventario = () => {
    ...
    if (loading) return (
        <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-slate-400 text-[10px] font-bold tracking-widest uppercase">Analizando datos maestros...</div>
        </div>
    );
    ...
    if (stats?.empty) return (
        <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-slate-400 text-xs uppercase tracking-widest">No hay datos disponibles. Iniciar conteos cíclicos.</div>
        </div>
    );
        ...
        <div className="max-w-[1400px] mx-auto px-6 py-3 font-sans bg-[#fcfcfc] min-h-screen text-slate-800">
            ...
            <div className="mb-6 border-b border-slate-200 pb-4 flex justify-between items-center">
                <div className="flex flex-col gap-0">
                    ...
                    <p className="text-slate-400 text-[8px] uppercase tracking-widest font-normal leading-none mt-0.5">Información de Rendimiento Operativo</p>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                ...
                {['A', 'B', 'C'].map(clase => (
                    <div key={clase} className="bg-white p-4 border border-slate-200 shadow-sm">
                        <label className="text-[9px] uppercase text-slate-400 font-bold tracking-widest block mb-2">Clase {clase} Exactitud</label>
                        <div className="flex items-baseline gap-0.5">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 border border-slate-200 shadow-sm h-full">
                        ...
                        <div className="space-y-6">
                            <div>
                                <label className="text-[9px] uppercase font-bold text-slate-400 tracking-widest block mb-1">Conciliación Neta</label>
                            ...
                            <div>
                                <label className="text-[9px] uppercase font-bold text-slate-400 tracking-widest block mb-1">Desviación Bruta</label>
                        ...
                        <table className="w-full text-left">
                            <thead className="bg-slate-50/50">
                                <tr>
                                    ...
                                    <th className="px-6 py-2 text-[9px] font-bold text-slate-400 uppercase tracking-widest text-right">Valor Absoluto</th>
                                </tr>
                            </thead>
                            ...
                            <div key={i}>
                                <div className="flex justify-between items-end mb-1.5">
                                    <div>
                                        ...
                                        <span className="text-[9px] text-slate-400 uppercase font-bold">{u.items} conteos</span>
                                    </div>
                                    <div className="text-right">
                            ...
                            <div key={i} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-slate-400">{z.total} Muestras</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className={`text-lg font-mono font-bold ${z.error_rate > 15 ? 'text-red-600' : 'text-slate-800'}`}>{z.error_rate}%</p>
                                    <p className="text-[8px] uppercase text-slate-300 font-bold tracking-tighter">Densidad</p>
                                </div>
                            </div>
                        ))}
                    </div>
