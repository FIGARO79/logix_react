...
const DashboardInventario = () => {
    ...
    if (loading) return (
        <div className="flex items-center justify-center min-h-[60vh]">
            <div className="text-zinc-900 text-[10px] font-medium  tracking-widest uppercase">Analizando datos maestros...</div>
        </div>
    );
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white p-6 border border-slate-200 shadow-sm h-full">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                <label className="text-[9px] uppercase font-medium  text-zinc-900 tracking-widest block mb-1">Desviación Bruta</label>
                        ...
                        {stats.productivity.map((u, i) => (
                            <div key={i}>
                                <div className="flex justify-between items-end mb-1.5">
                                    <div>
                                        <span className="text-xs font-medium  text-slate-700 block leading-tight">{u.user}</span>
                        ...
                        {stats.zones.map((z, i) => (
                            <div key={i} className="flex items-center justify-between py-2 border-b border-slate-50 last:border-0">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-[9px] uppercase font-medium  text-slate-500 tracking-widest">Zone {z.zone}</p>
                                        <p className="text-[10px] text-zinc-900">{z.total} Muestras</p>
                                    </div>
                                </div>
                                <div className="text-right">
                                    <p className={`text-lg font-mono font-medium  ${z.error_rate > 15 ? 'text-red-600' : 'text-slate-800'}`}>{z.error_rate}%</p>
