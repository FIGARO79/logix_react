...
const PackingListPrint = () => {
    ...
    return (
        <div className="bg-white min-h-screen text-black p-8 font-sans">
            ...
            {/* Printable Content - Full width when printing */}
            <div className="max-w-3xl mx-auto border p-8 bg-white print:border-none print:shadow-none print:w-full print:max-w-none print:p-0">
                {/* Header */}
                ...
                <div className="space-y-6 print:space-y-4">
                    {sortedPackageKeys.length === 0 ? (
                        ...
                        sortedPackageKeys.map((key, index) => (
                            <div key={key} className="page-break border rounded-lg break-inside-avoid shadow-sm print:shadow-none print:border-gray-300 print:mb-4" style={{ pageBreakInside: 'avoid' }}>
                                <div className="bg-gray-100 px-4 py-2 border-b flex justify-between items-center print:bg-gray-50 print:py-1">
                                    <h3 className="font-bold text-lg print:text-base">Bulto #{key}</h3>
                                ...
                                <table className="min-w-full text-sm">
                                    ...
                                    <tbody className="divide-y divide-gray-100">
                                        {packages[key] && packages[key].length > 0 ? (
